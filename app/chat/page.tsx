...
import { SuggestedTasksCard } from "@/components/suggested-tasks-card"; // Import the new component
import type { SuggestedPlan, PlanResponse, SuggestedTask } from "@/types/plan"; // Import shared types

// --- Type Definitions are imported from '@/types/plan' ---
...
export default function ChatPage() {
  ...
  const [suggestedPlan, setSuggestedPlan] = React.useState<SuggestedPlan | null>(null); // Use imported type
  ...
  }, [messages, suggestedPlan]); // Add suggestedPlan dependency
  ...
  const handleSaveAcceptedTasks = async () => {
    ...
    if (result.success) {
      ...
      setSuggestedPlan(null); // Clear suggestions on success
    } else {
      toast({
