  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className={inter.className}>
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem disableTransitionOnChange storageKey="sensei-theme">
              ...
              <div className="flex min-h-screen min-w-[99vw]">
                ...
                <main className="flex-1 overflow-auto mx-auto">
                  <div className="sticky top-0 z-10 flex items-center h-16 px-4 border-b bg-background">
                    ...
                    <Link href="http://localhost:3000/dashboard" className="font-semibold cursor-pointer hover:underline">
                      Jarvis
                    </Link>
                  </div>
